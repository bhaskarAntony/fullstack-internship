        ...
        <div className="row">
            ...
            <div className="col-md-6">
                <p className="fs-6 text-white d-flex gap-2 justify-content-end">
                    <a href="https://in.linkedin.com/company/be-practical-tech-solutions">Linkedin</a>
                    <span className='text-white'>|</span>
                    <a href="https://be-practical.com/blogs">Blog</a>
                    <span className='text-white'>|</span>
                    <a href="https://www.youtube.com/@bepracticaltechsolutions">Youtube</a>
                    <span className='text-white'>|</span>
                    <a href="https://www.instagram.com/bepracticaltechsolutions/?hl=en">Instagram</a>
                </p>
            </div>
        </div>
