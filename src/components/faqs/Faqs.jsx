  ...
  const handleClick = () => {
    ...
    return (
        <div className="container-fluid my-5 ">
            ...
            <div className="icon mb-3"><i class="bi bi-question-circle fs-1"></i></div>
            <div className="bar my-3"></div>
            <h1 className="fs-3 fw-bold text-main">FAQ's</h1>
        </div>
           <div className="row align-items-center light-bg2 p-3 p-md-5 mt-4">
            <div className="col-md-4">
            <img src="https://cdn-icons-png.flaticon.com/512/2302/2302083.png" alt="image" className="w-100" />
            </div>
            ...
            <center>
                <button className="main-btn mt-5 px-5" onClick={handleClick}>Still have you Doubt?</button>
            </center>
           </div>
